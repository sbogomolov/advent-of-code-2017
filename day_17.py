...
def main():
    ...
    # Part 1 can be solved with naive solution
    array = [0]
    pos = 0
    for i in range(1, 2018):
        pos = (pos + steps) % len(array) + 1
        array.insert(pos, i)

    print(array[pos + 1])

    # For Part 2 we do not need to construct the array,
    # it is necessary to keep track of all values inserted
    # right after 0
    pos = 0
